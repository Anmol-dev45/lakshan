    ...
    <div className="min-h-screen bg-white pb-24">
      ...
      <div className="px-6 py-4">
        ...
        <div className="bg-primary-50 rounded-3xl p-6 mb-8 text-center relative overflow-hidden shadow-sm">
          ...
          <div className="w-24 h-24 mx-auto bg-primary-500 rounded-full flex items-center justify-center text-white mb-6 shadow-float relative z-10 cursor-pointer hover:scale-105 transition-transform">
            <Mic size={40} />
          ...
          <button className="w-full bg-white border border-primary-200 text-primary-600 font-bold py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-primary-50 transition-colors shadow-sm relative z-10">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-white border border-surface-100 p-4 rounded-2xl shadow-sm hover:shadow-md transition-shadow cursor-pointer">
